		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<a class="btn btn-primary" href="<?php echo site_url()?>/pegawai/create" role="button">Input Daftar Pegawai</a>
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('pegawai/update/').$key->id ?>" type="button" class="btn btn-warning" onclick="return confirm('Anda Yakin Akan Edit')" >Update</a>
											<a href="<?php echo site_url('pegawai/delete/').$key->id ?>" type="button" class="btn btn-danger" onclick="return confirm('Anda Yakin Akan Menghapus')" >Delete</a>
